"""Legal Research Agent - Domain-Specific Connectors."""
...
class RelativityConnector:
    """Domain-specific connector for relativity integration with Legal Research Agent."""
...
class LogikcullConnector:
    """Domain-specific connector for logikcull integration with Legal Research Agent."""
...
class IroncladConnector:
    """Domain-specific connector for ironclad integration with Legal Research Agent."""
...
class DocusignClmConnector:
    """Domain-specific connector for docusign clm integration with Legal Research Agent."""
...
class WestlawConnector:
    """Domain-specific connector for westlaw integration with Legal Research Agent."""

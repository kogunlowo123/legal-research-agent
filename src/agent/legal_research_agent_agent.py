"""Legal Research Agent - Main Agent Implementation."""
...
class LegalResearchAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "search_case_law": self.tools.search_case_law,
            "analyze_precedent": self.tools.analyze_precedent,
            "search_statutes": self.tools.search_statutes,
            "summarize_decision": self.tools.summarize_decision,
            "draft_memo": self.tools.draft_memo,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['legal', 'research', 'compliance', 'audit_trail'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "analyze_precedent": ['analyze', 'precedent'],
            "search_statutes": ['search', 'statutes'],
            "summarize_decision": ['summarize', 'decision'],

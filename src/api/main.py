"""Legal Research Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Legal research agent that searches case law, statutes, and regulations, analyzes legal precedents, summarizes court decisions, and generates legal memoranda on specific topics.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,

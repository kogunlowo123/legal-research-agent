"""Application configuration for Legal Research Agent."""
...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/legal_research_agent",
    ...
    opensearch_index: str = Field(default="legal_research_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="legal-research-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="legal-research-agent", description="A2A agent ID")
